...
Class Many_Test inherits IO {
  ...
  myBool3 : Bool;
  myBool4 : Bool;
  myPrint(out1 : String, out2: String, out3: String): SELF_TYPE {
    {
    self.out_string("Invokation\n");
...
(* This test whether collection works correct  *)

Class Collect_Test_Main InhEriTs IO {
  myString1 : String <- myString; --use before define
...
(* Test method return type defined as SELF_TYPE *)
...
Class SELF_TYPE_TEST_Main InhEriTs IO {
  myString : String <- "Hello World!\n";
...
(* Test 'SELF_TYPE' in attribute *)
class Test_SELF_TYPE_A {
  myString(a: String, b: String ):String { myString };
  myString : String <- "Hi\n";
  mySelf : Test_SELF_TYPE_A <- self;
  mySelfAttr : SELF_TYPE <- self;
  mySelfAttr2 : SELF_TYPE;
};

class Test_SELF_TYPE_B inherits Test_SELF_TYPE_A {
  a : String ;
  test(): Object { a <- myString };
};


Class Case_Test_Good inherits IO {
  myString : String;
  outString: String <- "Hello World\n";
  myNum : Int <- 2;
  myPrint(out1 : Object): Object {
...
class Let_Test_Good inherits IO {
  myNum1 : Int  <- 3 ;
  myNum2 : Int  <- 2 ;
  myNum3 : Int;
  let_test (): Object {
