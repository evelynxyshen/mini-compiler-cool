...
public:
   ...
   Class__EXTRAS
#endif
virtual void visit_AST(void*, ostream&, int) = 0;
virtual void check_feature_def(void* class_tbl) = 0;
virtual Symbol class_name() = 0;
virtual Symbol parent_name() = 0;
virtual Features get_features() =0;
virtual void collect_inherit_feature(Class_ c, void*, void*, Class_) = 0;
};
...
public:
   ...
   Feature_EXTRAS
#endif
virtual void collect_feature(Class_ c, void* class_tbl, void* env_tbl)=0;
virtual void check_feature_def(Class_ c, void* class_tbl)=0;
virtual bool check_inherit_feature_def(Class_ c, void* class_tbl, Class_ parent_class)=0;
virtual void check_feature(Class_ c, void* class_tbl, void* env_tbl)=0;
virtual bool is_method()=0;
virtual bool find_method(Symbol method_name) =0;
virtual bool find_attribute(Symbol attr_name) = 0;
...
public:
   ...
   Expression_EXTRAS
#endif
virtual Symbol check_expr(Class_ c, void* class_tbl, void* env_tbl)=0;
};
...
public:
   ...
   Case_EXTRAS
#endif
virtual Symbol check_case_branch(Class_ c, void* class_tbl, void*env_tbl, void*decl_tbl)=0;
};
...
public:
   ...
   program_EXTRAS
#endif
  void visit_AST(void*, ostream& stream, int n);
};
...
#endif
  void visit_AST(void*, ostream& stream, int n);
  Symbol class_name() { return name;  }
  Symbol parent_name()  { return parent;  }
  void check_feature_def(void* class_tbl);
  Features get_features() { return features;  }
  void collect_inherit_feature(Class_ c, void*, void*, Class_);
};
...
public:
   ...
   method_EXTRAS
#endif
void collect_feature(Class_ c, void* class_tbl, void* env_tbl) {}
void check_feature_def(Class_ c, void* class_tbl);
bool check_inherit_feature_def(Class_ c, void* class_tbl, Class_ parent_class);
void check_feature(Class_ c, void* class_tbl, void* env_tbl); //{/*TODO*/}
bool is_method() { return true; }
bool find_method(Symbol method_name ) 
    { //cout << "To find method "<<method_name <<" This is "<<name<<endl;
      if(method_name == name) return true; else return false; }
bool find_attribute(Symbol attr_name) { return false; }
...
void collect_feature(Class_ c, void* class_tbl, void* env_tbl);
void check_feature_def(Class_ c, void* class_tbl); 
bool check_inherit_feature_def(Class_ c, void* class_tbl, Class_ parent_class);// { return true; }
void check_feature(Class_ c, void* class_tbl, void* env_tbl);
bool is_method() {  return false; }
bool find_method(Symbol method_name ) {return false;}
bool find_attribute(Symbol attr_name ) 
  { if(attr_name == name) return true; else return false;}
...
public:
   ...
   branch_EXTRAS
#endif
Symbol check_case_branch(Class_ c, void* class_tbl, void*env_tbl, void*decl_tbl);
};
...
public:
   ...
   assign_EXTRAS
#endif
Symbol check_expr(Class_ c, void* class_tbl, void* env_tbl);
};
...
public:
   ...
   loop_EXTRAS
#endif
Symbol check_expr(Class_ c, void* class_tbl, void* env_tbl); // { return no_type; }
};
