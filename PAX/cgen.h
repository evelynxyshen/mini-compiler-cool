...
public:
   ...
   SymbolTable<Symbol, Symbol> *formal_type;
   SymbolTable<Symbol, Symbol> *let_type;
//   int bind_num;
...
public:
   ...
   //first symbol is method name, second symbol is class name
   SymbolTable<Symbol, Symbol> *method_class_table;
   SymbolTable<Symbol, Symbol> *attr_type_table;
   int total_attr_num;
